...
func (UnimplementedWatchPermissionSetsServiceServer) WatchPermissionSets(*WatchPermissionSetsRequest, grpc.ServerStreamingServer[WatchPermissionSetsResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchPermissionSets not implemented")
}
func (UnimplementedWatchPermissionSetsServiceServer) LookupPermissionSets(*LookupPermissionSetsRequest, grpc.ServerStreamingServer[LookupPermissionSetsResponse]) error {
	return status.Error(codes.Unimplemented, "method LookupPermissionSets not implemented")
}
func (UnimplementedWatchPermissionSetsServiceServer) DownloadPermissionSets(context.Context, *DownloadPermissionSetsRequest) (*DownloadPermissionSetsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DownloadPermissionSets not implemented")
}
...
func RegisterWatchPermissionSetsServiceServer(s grpc.ServiceRegistrar, srv WatchPermissionSetsServiceServer) {
	// If the following call panics, it indicates UnimplementedWatchPermissionSetsServiceServer was
