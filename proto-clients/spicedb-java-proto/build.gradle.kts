...
dependencies {
    ...
    api("build.buf.gen:authzed_api_protocolbuffers_java:36.1.0.1.20260903162545.2361586d4325")
    api("build.buf.gen:authzed_api_grpc_java:1.84.0.2.20260903162545.2361586d4325")
