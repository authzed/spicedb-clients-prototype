...
public final class WatchPermissionSetsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest,
      com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> getDownloadPermissionSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DownloadPermissionSets",
      requestType = com.authzed.api.materialize.v0.DownloadPermissionSetsRequest.class,
      responseType = com.authzed.api.materialize.v0.DownloadPermissionSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest,
      com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> getDownloadPermissionSetsMethod() {
    io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest, com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> getDownloadPermissionSetsMethod;
    if ((getDownloadPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod) == null) {
      synchronized (WatchPermissionSetsServiceGrpc.class) {
        if ((getDownloadPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod) == null) {
          WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod = getDownloadPermissionSetsMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest, com.authzed.api.materialize.v0.DownloadPermissionSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DownloadPermissionSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.materialize.v0.DownloadPermissionSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.materialize.v0.DownloadPermissionSetsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new WatchPermissionSetsServiceMethodDescriptorSupplier("DownloadPermissionSets"))
              .build();
        }
      }
    }
    return getDownloadPermissionSetsMethod;
  }
   ...
   */
  public static WatchPermissionSetsServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingV2Stub>() {
        @java.lang.Override
        public WatchPermissionSetsServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new WatchPermissionSetsServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return WatchPermissionSetsServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void downloadPermissionSets(com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request,
        io.grpc.stub.StreamObserver<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDownloadPermissionSetsMethod(), responseObserver);
    }
  }
  ...
  public static final class WatchPermissionSetsServiceStub
     ...
     * </pre>
     */
    public void downloadPermissionSets(com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request,
        io.grpc.stub.StreamObserver<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDownloadPermissionSetsMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   */
  public static final class WatchPermissionSetsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<WatchPermissionSetsServiceBlockingV2Stub> {
    private WatchPermissionSetsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected WatchPermissionSetsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new WatchPermissionSetsServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.WatchPermissionSetsResponse>
        watchPermissionSets(com.authzed.api.materialize.v0.WatchPermissionSetsRequest request) {
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.LookupPermissionSetsResponse>
        lookupPermissionSets(com.authzed.api.materialize.v0.LookupPermissionSetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(
     ...
     * </pre>
     */
    public com.authzed.api.materialize.v0.DownloadPermissionSetsResponse downloadPermissionSets(com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
          getChannel(), getDownloadPermissionSetsMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class WatchPermissionSetsServiceBlockingStub
     ...
     * </pre>
     */
    public com.authzed.api.materialize.v0.DownloadPermissionSetsResponse downloadPermissionSets(com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request) {
  ...
  public static final class WatchPermissionSetsServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> downloadPermissionSets(
        com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getDownloadPermissionSetsMethod(), getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DOWNLOAD_PERMISSION_SETS:
          serviceImpl.downloadPermissionSets((com.authzed.api.materialize.v0.DownloadPermissionSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getDownloadPermissionSetsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.authzed.api.materialize.v0.DownloadPermissionSetsRequest,
              com.authzed.api.materialize.v0.DownloadPermissionSetsResponse>(
                service, METHODID_DOWNLOAD_PERMISSION_SETS)))
        .build();
  }
      ...
      synchronized (WatchPermissionSetsServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getDownloadPermissionSetsMethod())
              .build();
        }
      }
    }
