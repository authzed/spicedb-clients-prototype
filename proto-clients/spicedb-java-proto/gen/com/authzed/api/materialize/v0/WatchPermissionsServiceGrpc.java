...
public final class WatchPermissionsServiceGrpc {
   ...
   */
  public static WatchPermissionsServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingV2Stub>() {
        @java.lang.Override
        public WatchPermissionsServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new WatchPermissionsServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return WatchPermissionsServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class WatchPermissionsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<WatchPermissionsServiceBlockingV2Stub> {
    private WatchPermissionsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected WatchPermissionsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new WatchPermissionsServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.WatchPermissionsResponse>
        watchPermissions(com.authzed.api.materialize.v0.WatchPermissionsRequest request) {
