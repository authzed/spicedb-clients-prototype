...
private static final long serialVersionUID = 0L;
  ...
  private LookupResourcesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final int WITH_DEBUG_FIELD_NUMBER = 8;
  private boolean withDebug_ = false;
  /**
   * <pre>
   *
   ...
   * </pre>
   *
   * <code>bool with_debug = 8 [json_name = "withDebug"];</code>
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getWithDebug()
        != other.getWithDebug()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + WITH_DEBUG_FIELD_NUMBER;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.authzed.api.v1.LookupResourcesRequest other) {
      ...
      if (other.getWithDebug() != false) {
        setWithDebug(other.getWithDebug());
      }
     ...
     *
     * <code>bool with_debug = 8 [json_name = "withDebug"];</code>
     * @param value The withDebug to set.
     * @return This builder for chaining.
     */
    public Builder setWithDebug(boolean value) {
