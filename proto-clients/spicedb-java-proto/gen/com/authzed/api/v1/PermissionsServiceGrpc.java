...
public final class PermissionsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1.ImportBulkRelationshipsRequest,
      com.authzed.api.v1.ImportBulkRelationshipsResponse> getImportBulkRelationshipsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ImportBulkRelationships",
      requestType = com.authzed.api.v1.ImportBulkRelationshipsRequest.class,
      responseType = com.authzed.api.v1.ImportBulkRelationshipsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1.ImportBulkRelationshipsRequest,
      com.authzed.api.v1.ImportBulkRelationshipsResponse> getImportBulkRelationshipsMethod() {
    ...
    if ((getImportBulkRelationshipsMethod = PermissionsServiceGrpc.getImportBulkRelationshipsMethod) == null) {
      synchronized (PermissionsServiceGrpc.class) {
        if ((getImportBulkRelationshipsMethod = PermissionsServiceGrpc.getImportBulkRelationshipsMethod) == null) {
          PermissionsServiceGrpc.getImportBulkRelationshipsMethod = getImportBulkRelationshipsMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1.ImportBulkRelationshipsRequest, com.authzed.api.v1.ImportBulkRelationshipsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ImportBulkRelationships"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.ImportBulkRelationshipsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.ImportBulkRelationshipsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1.ExportBulkRelationshipsRequest,
      com.authzed.api.v1.ExportBulkRelationshipsResponse> getExportBulkRelationshipsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExportBulkRelationships",
      requestType = com.authzed.api.v1.ExportBulkRelationshipsRequest.class,
      responseType = com.authzed.api.v1.ExportBulkRelationshipsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1.ExportBulkRelationshipsRequest,
      com.authzed.api.v1.ExportBulkRelationshipsResponse> getExportBulkRelationshipsMethod() {
    ...
    if ((getExportBulkRelationshipsMethod = PermissionsServiceGrpc.getExportBulkRelationshipsMethod) == null) {
      synchronized (PermissionsServiceGrpc.class) {
        if ((getExportBulkRelationshipsMethod = PermissionsServiceGrpc.getExportBulkRelationshipsMethod) == null) {
          PermissionsServiceGrpc.getExportBulkRelationshipsMethod = getExportBulkRelationshipsMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1.ExportBulkRelationshipsRequest, com.authzed.api.v1.ExportBulkRelationshipsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExportBulkRelationships"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.ExportBulkRelationshipsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.ExportBulkRelationshipsResponse.getDefaultInstance()))
   ...
   */
  public static PermissionsServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PermissionsServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PermissionsServiceBlockingV2Stub>() {
        @java.lang.Override
  ...
  public interface AsyncService {
    ...
    default io.grpc.stub.StreamObserver<com.authzed.api.v1.ImportBulkRelationshipsRequest> importBulkRelationships(
      ...
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getImportBulkRelationshipsMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class PermissionsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<PermissionsServiceBlockingV2Stub> {
    private PermissionsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected PermissionsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new PermissionsServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.v1.ReadRelationshipsResponse>
        readRelationships(com.authzed.api.v1.ReadRelationshipsRequest request) {
     ...
     * </pre>
     */
    public com.authzed.api.v1.WriteRelationshipsResponse writeRelationships(com.authzed.api.v1.WriteRelationshipsRequest request) throws io.grpc.StatusException {
     ...
     * </pre>
     */
    public com.authzed.api.v1.DeleteRelationshipsResponse deleteRelationships(com.authzed.api.v1.DeleteRelationshipsRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
     ...
     * </pre>
     */
    public com.authzed.api.v1.CheckPermissionResponse checkPermission(com.authzed.api.v1.CheckPermissionRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
     ...
     * </pre>
     */
    public com.authzed.api.v1.CheckBulkPermissionsResponse checkBulkPermissions(com.authzed.api.v1.CheckBulkPermissionsRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
     ...
     * </pre>
     */
    public com.authzed.api.v1.ExpandPermissionTreeResponse expandPermissionTree(com.authzed.api.v1.ExpandPermissionTreeRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.v1.LookupResourcesResponse>
        lookupResources(com.authzed.api.v1.LookupResourcesRequest request) {
      return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.v1.LookupSubjectsResponse>
        lookupSubjects(com.authzed.api.v1.LookupSubjectsRequest request) {
      return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<com.authzed.api.v1.ImportBulkRelationshipsRequest, com.authzed.api.v1.ImportBulkRelationshipsResponse>
        importBulkRelationships() {
      return io.grpc.stub.ClientCalls.blockingClientStreamingCall(
          getChannel(), getImportBulkRelationshipsMethod(), getCallOptions());
    }
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<?, com.authzed.api.v1.ExportBulkRelationshipsResponse>
        exportBulkRelationships(com.authzed.api.v1.ExportBulkRelationshipsRequest request) {
      return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(
          getChannel(), getExportBulkRelationshipsMethod(), getCallOptions(), request);
    }
  }
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.authzed.api.v1.ImportBulkRelationshipsRequest,
              com.authzed.api.v1.ImportBulkRelationshipsResponse>(
                service, METHODID_IMPORT_BULK_RELATIONSHIPS)))
        .addMethod(
          getExportBulkRelationshipsMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.authzed.api.v1.ExportBulkRelationshipsRequest,
              com.authzed.api.v1.ExportBulkRelationshipsResponse>(
      ...
      synchronized (PermissionsServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getImportBulkRelationshipsMethod())
              .addMethod(getExportBulkRelationshipsMethod())
              .build();
        }
      }
    }
