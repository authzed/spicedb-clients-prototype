...
This is the idiomatic C# client for SpiceDB.

## What to do

1. Read `../DESIGN.md` (root) for overall vision and backwards compat rules
2. Read `./DESIGN.md` for C#-specific goals — this takes precedence
...
5. Propagate deprecation markers using `[Obsolete("Use XYZ instead")]`
...
9. Run `dotnet test SpiceDB.Client.sln` after making changes
