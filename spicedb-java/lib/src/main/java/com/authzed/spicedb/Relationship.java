 ...
 *
 * <p>Avoids nested proto types in favor of plain Java fields. Use
 * {@link #of} or {@link #fromTuple} to construct instances.
 *
...
public record Relationship(
    ...
    public static Relationship of(
        ...
        if (resourceType == null || resourceType.isEmpty()
                ...
                || resourceRelation == null || resourceRelation.isEmpty()) {
    ...
    public String toString() {
        var sb = new StringBuilder()
            .append(resourceType).append(':').append(resourceID)
            .append('#').append(resourceRelation)
            .append('@')
            .append(subjectType).append(':').append(subjectID);
