...
class TransactionTest {
    ...
    private static final Relationship REL = Relationship.of(
    ...
    void mustNotMatchAddsPrecondition() {
        ...
        assertEquals(Transaction.PreconditionOperation.MUST_NOT_MATCH,
            txn.preconditions().get(0).operation());
    ...
    void mustMatchAddsPrecondition() {
        ...
        assertEquals(1, txn.preconditions().size());
        assertEquals(Transaction.PreconditionOperation.MUST_MATCH,
            txn.preconditions().get(0).operation());
    }
